...
class RiskService:
    ...
    @staticmethod
    def list_assessments_for_user(user_id: int) -> List[risk_assessment]:
        """
        Retorna todas as avaliações de risco criadas por um usuário.
        """
        return risk_assessment.query.filter_by(created_by=user_id).all()
