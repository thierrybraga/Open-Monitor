...
from ..models.monitoring_rule import MonitoringRule # Corrigido
from ..models.vulnerability import Vulnerability # Corrigido
from ..models.vendor import Vendor # Corrigido (assumindo este modelo existe e está relacionado a Vulnerability)
